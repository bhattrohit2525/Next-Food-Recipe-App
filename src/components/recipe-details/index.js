...
export default function RecipeDetailsItem({ getRecipeDetails }) {
  return (
    <div className="bg-gradient-to-r from-purple-500 to-pink-500">
      ...
      <Link href={"/recipe-list"} className="mt-5 h-20 pt-5  flex justify-center">Go to recipe list</Link>
      <Link href={"/"} className="mt-5 h-20 pt-5  flex justify-center">Go Home</Link>
    </div>
  );
}